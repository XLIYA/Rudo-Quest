...
| `GITHUB_TOKEN_ENCRYPTION_KEY`                                                                                                             | Server-only | GitHub integration only  | Dedicated key for AES-256-GCM encryption of pending GitHub user tokens (rotate = re-link installations) |
